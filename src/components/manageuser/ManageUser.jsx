...
function ManageUser() {
  ...
  const handleDelete = () => {
    ...
    const modData = details.filter(
      (item) => item.id !== JSON.parse(localStorage.getItem("selected"))
    );
    localStorage.setItem("details", JSON.stringify(modData));
    setData(modData);
  };
    ...
    <div className="container-fluid p-0 d-flex flex-row">
      ...
      <div className="manage">
        ...
        <div className="managemenu">
          <button className="manageuser-button" onClick={handleCreate}>
            Create User
          </button>
          <button className="manageuser-button11" onClick={() => handleEdit()}>
            Edit
          </button>
          <button className="manageuser-button1" onClick={() => handleDelete()}>
            Delete
          </button>
        </div>
