      ...
      <div className="con">
        ...
        <div className="sec1">
          ...
          <div className="overlay">
            <div className="cont">
              <a href="images/dev3/1652163659947.png" target="_blank">Zoom</a>
...
<input type="text" className="form-control" placeholder="enter message"/>
        ...
        <div className="sec1">
          <img src="images/dev3/1652164143154.png" className="mojii" alt="images" />
          <div className="overlay">
            <div className="cont">
              <a href="images/dev3/1652164143154.png" target="_blank">Zoom</a>
              <a href="#" className="button" onClick={() => setmodal(true)}>Comments</a>
            </div>
          </div>
        </div>
        <div className="sec1">
          <img src="images/dev3/1652164745232.png" className="mojii" alt="images" />
          <div className="overlay">
            <div className="cont">
              <a href="images/dev3/1652164745232.png" target="_blank">Zoom</a>
              <a href="#" className="button" onClick={() => setmodal(true)}>Comments</a>
            </div>
          </div>
        </div>
        <div className="sec1">
          <img src="images/dev3/1652165348396.png" className="mojii" alt="images" />
          <div className="overlay">
            <div className="cont">
              <a href="images/dev3/1652165348396.png" target="_blank">Zoom</a>
              <a href="#" className="button" onClick={() => setmodal(true)}>Comments</a>
            </div>
          </div>
        </div>
